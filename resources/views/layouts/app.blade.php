                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @lang('messages.words.browse')
                            </a>
                            <div class="dropdown-menu custom-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/threads">@lang('messages.words.threads')</a>
                                @auth
                                <a href="/threads?by={{ auth()->user()->name }}" class="dropdown-item">
                                    @lang('messages.words.myThreads')
                                </a>
                                @endauth
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu custom-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a href="{{ route('thread_channel', $channel->slug) }}" class="dropdown-item" href="#">
                                    {{ $channel->name }}
                                </a>
                                @endforeach
                            </div>
